...
class AcGePoint2d;
#else
using AcGeMatrix3d = OdGeMatrix3d;
using AcGePoint3d = OdGePoint3d;
using AcGeVector3d = OdGeVector3d;
using AcGePoint2d = OdGePoint2d;
using AcGeExtents3d = OdGeExtents3d;
#endif

template<class T, class A = OdMemoryAllocator<T>>
using AcArray = OdArray<T, A>;

using AcDbDatabase = OdDbDatabase;
using AcDbObjectId = OdDbObjectId;
using AcGiDrawable = OdGiDrawable;
using AcGePoint3dArray = OdGePoint3dArray;
using ACHAR = OdChar;
using AcDbEntity = OdDbEntity;
...
/// </description>  
class DRAWBRIDGE_MAC_API AcGsGraphicsKernel
{
public:
